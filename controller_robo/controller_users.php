<?php
    ...
    switch ($_REQUEST['act']) {
        ...
        break;
            ...
            case 'users_get_by_pass':
                if(!isset($userAccess["get_users"]) && !$debugMode ){
                    controller_main_function::send_msg(lang::$not_access, lang::$error);
                    }
                $valid_data = controller_main_function::check_validation(array("pass"));
                if (!isset($valid_data['is_valid']) || $valid_data['is_valid'] == false) {
                    controller_main_function::send_msg(lang::$invalid_data, lang::$error);
                }
                $result = access_users::get_users_by_pass($_REQUEST["pass"]);
                controller_main_function::send_result($result);
            break;
            ...
            if(!isset($userAccess["edit_users"]) && !$debugMode ){
                ...
                $valid_data = controller_main_function::check_validation(array("ID" ,"username" ,"pass" ,"creationDate"));
                if (!isset($valid_data['is_valid']) || $valid_data['is_valid'] == false) {
                    controller_main_function::send_msg(lang::$invalid_data, lang::$error);
                }
                $result = access_users::edit_users($_REQUEST["ID"],$_REQUEST["username"],$_REQUEST["pass"],$_REQUEST["creationDate"]);
                //controller_main_function::send_result($result);
            ...
            if(!isset($userAccess["edit_users"]) && !$debugMode){
                ...
                $result = access_users::edit_users_by_ID($_REQUEST["ID"],$_REQUEST["username"],$_REQUEST["pass"],$_REQUEST["creationDate"]);
                //controller_main_function::send_result($result);
                //$result = array('data'=> true);
                //controller_main_function::send_result($result);
                controller_main_function::send_msg(lang::$success, lang::$message, "success");
            ...
            if(!isset($userAccess["edit_users"]) && !$debugMode){
                ...
                $result = access_users::edit_users_by_username($_REQUEST["ID"],$_REQUEST["username"],$_REQUEST["pass"],$_REQUEST["creationDate"]);
                //controller_main_function::send_result($result);
                //$result = array('data'=> true);
                //controller_main_function::send_result($result);
                controller_main_function::send_msg(lang::$success, lang::$message, "success");
            ...
            if(!isset($userAccess["edit_users"]) && !$debugMode){
                ...
                $result = access_users::edit_users_by_pass($_REQUEST["ID"],$_REQUEST["username"],$_REQUEST["pass"],$_REQUEST["creationDate"]);
                //controller_main_function::send_result($result);
                //$result = array('data'=> true);
                //controller_main_function::send_result($result);
                controller_main_function::send_msg(lang::$success, lang::$message, "success");
            ...
            if(!isset($userAccess["edit_users"]) && !$debugMode){
                ...
                $result = access_users::edit_users_by_creationDate($_REQUEST["ID"],$_REQUEST["username"],$_REQUEST["pass"],$_REQUEST["creationDate"]);
                //controller_main_function::send_result($result);
                //$result = array('data'=> true);
                //controller_main_function::send_result($result);
                controller_main_function::send_msg(lang::$success, lang::$message, "success");
            ...
            case 'users_edit_pass_by_ID':
            if(!isset($userAccess["edit_users"]) && !$debugMode){
                    controller_main_function::send_msg(lang::$not_access, lang::$error);
                    }
                $valid_data = controller_main_function::check_validation(array("ID","pass"));
                if (!isset($valid_data['is_valid']) || $valid_data['is_valid'] == false) {
                    controller_main_function::send_msg(lang::$invalid_data, lang::$error);
                }
                $result = access_users::edit_users_pass_by_ID($_REQUEST["ID"],$_REQUEST["pass"]);
                //controller_main_function::send_result($result);
                //$result = array('data'=> true);
                //controller_main_function::send_result($result);
                controller_main_function::send_msg(lang::$success, lang::$message, "success");
            ...
            if(!isset($userAccess["set_users"]) && !$debugMode){
                ...
                $valid_data = controller_main_function::check_validation(array("username" ,"pass"));
                if (!isset($valid_data['is_valid']) || $valid_data['is_valid'] == false) {
                    controller_main_function::send_msg(lang::$invalid_data, lang::$error);
                }
                $result = access_users::set_users($_REQUEST["username"],$_REQUEST["pass"]);
                //controller_main_function::send_result($result);
                //$result = array('data'=> true);
                //controller_main_function::send_result($result);
                controller_main_function::send_msg(lang::$success, lang::$message, "success");

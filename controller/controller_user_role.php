...
require_once '../model/data_access/access_user_role.php';
...
if (isset($_REQUEST['act']) && $_REQUEST['act'] != '' && $_REQUEST['act'] != null) {
    ...
    switch ($_REQUEST['act']) {
        ...
        case 'user_role_get':
            if (!isset($userAccess["get_user_role"]) && !$debugMode) {
                controller_main_function::send_msg(lang::$not_access, lang::$error);
            }
            $result = access_user_role::get_user_role();
        ...
        case 'user_role_get_by_id':
            ...
            $result = access_user_role::get_user_role_by_id($_REQUEST["id"]);
            controller_main_function::send_result($result);
            break;

        case 'user_role_get_by_name':
            if (!isset($userAccess["get_user_role"]) && !$debugMode) {
                controller_main_function::send_msg(lang::$not_access, lang::$error);
            }
            ...
            $result = access_user_role::get_user_role_by_name($_REQUEST["name"]);
            controller_main_function::send_result($result);
            break;
        //_____________update act

        case 'user_role_edit':
            if (!isset($userAccess["edit_user_role"]) && !$debugMode) {
                controller_main_function::send_msg(lang::$not_access, lang::$error);
            }
            ...
            $result = access_user_role::edit_user_role($_REQUEST["id"], $_REQUEST["name"]);
            //controller_main_function::send_result($result);
        ...
        case 'user_role_edit_by_id':
            ...
            $result = access_user_role::edit_user_role_by_id($_REQUEST["id"], $_REQUEST["name"]);
            //controller_main_function::send_result($result);
            //$result = array('data'=> true);
            //controller_main_function::send_result($result);
            controller_main_function::send_msg(lang::$success, lang::$message, "success");
        ...
        case 'user_role_edit_by_name':
            ...
            $result = access_user_role::edit_user_role_by_name($_REQUEST["id"], $_REQUEST["name"]);
            //controller_main_function::send_result($result);
            //$result = array('data'=> true);
            //controller_main_function::send_result($result);
            controller_main_function::send_msg(lang::$success, lang::$message, "success");
        ...
        case 'user_role_edit_id_by_id':
            ...
            $result = access_user_role::edit_user_role_id_by_id($_REQUEST["id"], $_REQUEST["id"]);
            //controller_main_function::send_result($result);
            //$result = array('data'=> true);
            //controller_main_function::send_result($result);
            controller_main_function::send_msg(lang::$success, lang::$message, "success");
        ...
        case 'user_role_edit_name_by_id':
            if (!isset($userAccess["edit_user_role"]) && !$debugMode) {
                controller_main_function::send_msg(lang::$not_access, lang::$error);
            }
            $valid_data = controller_main_function::check_validation(array("id", "name"));
            ...
            $result = access_user_role::edit_user_role_name_by_id($_REQUEST["id"], $_REQUEST["name"]);
            //controller_main_function::send_result($result);
            //$result = array('data'=> true);
            //controller_main_function::send_result($result);
            controller_main_function::send_msg(lang::$success, lang::$message, "success");
        ...
        case 'user_role_delete':
            if (!isset($userAccess["delete_user_role"]) && !$debugMode) {
                controller_main_function::send_msg(lang::$not_access, lang::$error);
            }
            $valid_data = controller_main_function::check_validation(array("id"));
            if (!isset($valid_data['is_valid']) || $valid_data['is_valid'] == false) {
            ...
            $result = access_user_role::delete_user_role_by_id($_REQUEST["id"]);
            //controller_main_function::send_result($result);
            //$result = array('data'=> true);
            //controller_main_function::send_result($result);
            controller_main_function::send_msg(lang::$success, lang::$message, "success");
        ...
        case 'user_role_set':
            if (!isset($userAccess["set_user_role"]) && !$debugMode) {
                controller_main_function::send_msg(lang::$not_access, lang::$error);
            }
            $valid_data = controller_main_function::check_validation(array("name"));
            if (!isset($valid_data['is_valid']) || $valid_data['is_valid'] == false) {
            ...
            $result = access_user_role::set_user_role($_REQUEST["name"]);
            //controller_main_function::send_result($result);
            //$result = array('data'=> true);
            //controller_main_function::send_result($result);
            controller_main_function::send_msg(lang::$success, lang::$message, "success");

...
var messages_connection = {
    controller_url: '../controller_robo/controller_messages.php'
    , debug_mode: false
    , data: null
};
...
messages_connection.get_grid_call_back = function (data) {
    ...
    grid_messages.cols = [
        {name: 'ID', hidden: false, type: 'text'}, {name: 'user_id', hidden: false, type: 'text'}, {
            ...
            hidden: false,
            type: 'text'
        }, {name: 'text', hidden: false, type: 'text'}, {
            name: 'replay',
            hidden: false,
            type: 'text'
        }, {name: 'replay_date', hidden: false, type: 'text'}, {
            name: 'created_by',
            hidden: false,
            type: 'text'
...
messages_connection.get_by_replay_date = function (replay_date) {
    var param = {
        "act": "messages_get_by_replay_date",
...
messages_connection.get_by_created_by = function (created_by) {
    var param = {
        "act": "messages_get_by_created_by",
...
messages_connection.get_by_creationDate = function (creationDate) {
    var param = {
        "act": "messages_get_by_creationDate",
...
messages_connection.edit_user_id_by_ID = function (ID, user_id) {
    var param = {
        "act": "messages_edit_user_id_by_ID",
        user_id: user_id,
        ID: ID
    };
...
messages_connection.edit_replay_by_ID = function (ID, replay) {
    var param = {
        "act": "messages_edit_replay_by_ID",
        replay: replay,
        ID: ID
    };
...
messages_connection.edit_by_replay_date = function (ID, user_id, title, text, replay, replay_date, created_by, creationDate) {
    var param = {
        "act": "messages_edit_by_replay_date",
        ID: ID,
        user_id: user_id,
        title: title,
        text: text,
...
messages_connection.edit_replay_date_by_ID = function (ID, replay_date) {
    var param = {
        "act": "messages_edit_replay_date_by_ID",
        replay_date: replay_date,
        ID: ID
    };
...
messages_connection.edit_by_created_by = function (ID, user_id, title, text, replay, replay_date, created_by, creationDate) {
    var param = {
        "act": "messages_edit_by_created_by",
        ID: ID,
        user_id: user_id,
        title: title,
        text: text,
...
messages_connection.edit_created_by_by_ID = function (ID, created_by) {
    var param = {
        "act": "messages_edit_created_by_by_ID",
        created_by: created_by,
        ID: ID
    };
...
messages_connection.edit_by_creationDate = function (ID, user_id, title, text, replay, replay_date, created_by, creationDate) {
    var param = {
        "act": "messages_edit_by_creationDate",
        ID: ID,
        user_id: user_id,
        title: title,
        text: text,
...
messages_connection.edit_creationDate_by_ID = function (ID, creationDate) {
    var param = {
        "act": "messages_edit_creationDate_by_ID",
        creationDate: creationDate,
        ID: ID
    };
